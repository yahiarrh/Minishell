...
SRC	=	main.c builtins/cd.c builtins/echo.c builtins/env.c builtins/exit.c builtins/export.c builtins/ft_getval.c builtins/pwd.c builtins/unset.c\
		...
		executor/commands/exec_comm.c executor/commands/exev.c executor/commands/filtre_comm.c executor/signals/signal.c expander/exp_utils.c expander/expand.c expander/get_ptr.c\
		...
		parcing/lexer/indice_check/wrd_pipe.c parcing/lexer/utils/ft_tokchr.c parcing/lexer/utils/token_back.c parcing/lexer/indice_check/quotes.c parcing/lexer/utils/ft_subtoken.c parcing/lexer/utils/last_token.c parcing/lexer/utils/t_utils.c
