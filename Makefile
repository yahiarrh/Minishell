...
SRC	=	./lexer/tokenizer.c ./lexer/utils/ft_tokchr.c ./lexer/utils/ft_subtoken.c ./lexer/utils/last_token.c ./lexer/utils/token_back.c \
		...
		./builtins/env.c ./builtins/echo.c ./builtins/cd.c ./builtins/unset.c ./builtins/export.c ./builtins/exit.c utils_pars.c  utils_pars1.c utils_pars2.c
