...
builtins/utils/ft_err_msg.c  builtins/utils/lstadd_back.c builtins/utils/lstlast.c     builtins/utils/lstnew.c      builtins/utils/util.c\
		...
		parcing/lexer/indice_check/wrd_pipe.c parcing/lexer/utils/ft_tokchr.c parcing/lexer/utils/token_back.c parcing/lexer/indice_check/quotes.c \
		parcing/lexer/utils/ft_subtoken.c parcing/lexer/utils/last_token.c parcing/lexer/utils/t_utils.c
